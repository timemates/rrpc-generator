...
public object CombinedFilesMetadataGenerator {
    ...
    public fun generate(
        ...
        val mName = name ?: "MetadataLookupGroup${Random.nextInt(0, 999999)}"

        return FileSpec.builder(ClassName("org.timemates.rrpc.generated", mName))
            .addType(
                TypeSpec.objectBuilder(mName)
                    .addSuperinterface(
                        ...
                        delegate = buildCodeBlock {
                            ...
                            withIndent {
                                resolver.resolveAvailableFiles()
                                    .filterNot { file ->
                                        file.packageName?.value?.startsWith("wire") == true
                                            || file.packageName?.value?.startsWith("google.protobuf") == true
                                    }
                                    .forEach { file ->
                                    newline()
