...
import org.timemates.rrpc.codegen.plugin.*
        ...
        withContext(Dispatchers.IO) {
            ...
            communication.send(
                GeneratorMessage {
                    ...
                    systemLogger.debug("Sending the message with the parsed input files. Generation output: ${genOutput.absolutePath}. Options: $")
                }
            )
