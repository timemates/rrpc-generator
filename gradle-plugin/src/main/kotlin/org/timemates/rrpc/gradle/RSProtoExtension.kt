...
public open class RRpcExtension(objects: ObjectFactory) {
     ...
     */
    public val pluginConfigurations: ListProperty<PluginConiguration> =
        objects.listProperty(PluginConfiguration::class.java)
     ...
     * @see org.timemates.rrpc.gradle.configuration.ConfigurationOptions.Kotlin
     */
